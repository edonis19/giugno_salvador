...
import 'package:salvador_task_management/src/models/ultimamodifica_model.dart' as ultimaModifica;
...
var localdbProvider = FutureProvider((ref) async {
  final dir = await getApplicationDocumentsDirectory();
  final isar = Isar.open(
    schemas: [SyncLogSchema, articolo.ArticoloSchema, cliente.ClienteSchema, intervento.InterventoSchema, ultimaModifica.UltimaModificaInterventoSchema],
    directory: dir.path,
    name: 'localdb'
  );
