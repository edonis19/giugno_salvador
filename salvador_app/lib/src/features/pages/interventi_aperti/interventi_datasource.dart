...
class InterventiApertiDataSource extends DataGridSource {
  ...
  List<DataGridRow> get rows {
    ...
    //     DataGridCell<String>(
    //       columnName: 'numDoc',
    //       value: (nuovoIntervento.numDoc == null ||
    //               nuovoIntervento.numDoc == 'null')
    //           ? ''
    //           : nuovoIntervento.numDoc,
    //     ),
    ...
    //     DataGridCell<String>(
    //       columnName: 'targa',
    //       value: '${nuovoIntervento.rifMatricolaCliente}',
    //     ),
    //     DataGridCell<String>(
    //       columnName: 'status',
        ...
        if (dataGridCell.columnName == 'button') {
          return IconButton(
            onPressed: () {
              ...
              //   ref
              //       .read(interventoApertoStateProvider.notifier)
              //       .setIntervento(nuovoInterventoButton);
