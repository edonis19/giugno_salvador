...
int serializeIntervento(IsarWriter writer, Intervento object) {
          ...
          -9223372036854775808);
  {
    ...
    final listWriter = IsarCore.beginList(writer, 35, list.length);
  ...
  IsarCore.writeBool(writer, 36, object.isDirty);
...
Intervento deserializeIntervento(IsarReader reader) {
  ...
  {
    final length = IsarCore.readList(reader, 35, IsarCore.readerPtrPtr);
    {
  ...
  final bool _isDirty;
  _isDirty = IsarCore.readBool(reader, 36);
...
class _InterventoUpdateImpl implements _InterventoUpdate {
  ...
  bool call({
    ...
    return collection.updateProperties([
          ...
          if (isDirty != ignore) 36: isDirty as bool?,
        }) >
        0;
  }
}
...
extension InterventoQueryFilter
  ...
  QueryBuilder<Intervento, Intervento, QAfterFilterCondition>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const GreaterOrEqualCondition(property: 35, value: null),
      );
    });
  }
