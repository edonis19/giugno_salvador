                    ...
                    if (isSmallScreen) {
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                         ...
                         return ListTile(
  title: Text('${(intervento.numDoc == null ||
                   intervento.numDoc == 'null')
               ? ''
               : intervento.numDoc} - ${intervento.cliente?.descrizione ?? ''}'),
  subtitle: Column(
...
void applyFilter({
  ...
  interventi.when(
    data: (data) {
      ...
      ref.read(interventiStateRepositoryProvider.notifier).updateInterventiErp(nuovoInterventoList);
    },
