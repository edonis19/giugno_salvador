...
String? _selectedRifMatrPadre;
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    var matricoleData = ref.watch(elencoMatricoleControllerProvider);
    //var clientiData = ref.watch(clientiCollectionRepositoryProvider);
    final intervento = ref.watch(interventoApertoStateProvider);
    var elencoMatricole = ref.read(elencoMatricoleApiRepositoryProvider).getMatricola(utente: 'ADMIN');
                  ...
                  onPressed: () async {
                    ...
                    final clientiFiltrati = clientiData
                        .where((cliente) =>
                            ...
                            cliente.codice == _selectedCodCli)
                        .toList();
            ...
            final operatore = prefs.getString('user')?.toUpperCase();
                    ...
                    final nuovoIntervento = Intervento(
                        ...
                        cliente: InterventoCliente(
                          ...
                          codice: _selectedCodCli,
                          descrizione: _selectedDesCli,
                        ...
                        telefono1: null,
                        telefono2: null,
                        matricola: _selectedMatricola,
                        telaio: _selectedTelaio,
                        rifMatricolaCliente: _selectedTarga,
...
Container(
  ...
  child: matricoleData.when(
    data: (targaCollection) {
      var targaItems = targaCollection.map<ElencoMatricole>((targa) => ElencoMatricole(
        id: targa.id,
        rifMatricolaCliente: targa.rifMatricolaCliente ?? '',
        codCli: targa.codCli,
        desCli: targa.desCli,
        codice: targa.codice,
        telaio: targa.telaio, 
        ...
        ..removeWhere((item) => item.rifMatricolaCliente!.isEmpty || item.rifMatricolaCliente!.trim().isEmpty);
      ...
      return DropdownSearch<ElencoMatricole>(
        ...
        itemAsString: (ElencoMatricole item) => '${item.rifMatricolaCliente ?? ''} - ${item.descrizione}',
