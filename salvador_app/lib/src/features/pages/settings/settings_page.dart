                ...
                TextButton(
                  onPressed: () async {
                    ...
                    try {
                      ...
                      // nope. this is only for debug. the values are handled by the provider
                      ...
                      // todo - maybe this is what you wanted to do?
                      interventiDbNotifierErp.updateInterventiErp(interventi);
                      ...
                      var elencoMatricoleDbNotifier = ref.read(elencoMatricoleDbRepositoryProvider.notifier);
                      elencoMatricoleDbNotifier.updateElencoMatricole(elencoMatricole);
                    } catch (error) {
                      print(error);
                    } finally {
                      setState(() {
